...
require (
	...
	github.com/ahmetkarakayaoffical/ent v0.0.3
	github.com/ahmetkarakayaoffical/nats v0.0.3
	github.com/ahmetkarakayaoffical/utils v0.0.3
	github.com/ahmetkarakayaoffical/wingetcfg v0.0.3
